...
class TAPNextFromSAMNode(Node):
    def __init__(self):
        super().__init__("back_tapnext_from_sam_node")

        self.declare_parameter("image_topic", "/back_camera/color/image_raw")
        self.declare_parameter("sam_keypoints_topic", "/back_camera/sam_rope/keypoints")
        self.declare_parameter("tracked_keypoints_topic", "/back_camera/tapnext/keypoints")
        self.declare_parameter(
            "annotated_topic",
            "/back_camera/tapnext/annotated_image/compressed",
        )
        self.declare_parameter(
